                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-6 gap-6">
                                    <div className="col-span-2">
                                        <Select showLabel label="Role ID" options={formInit?.jenjang} labelKey="nama"
                                                valueKey="id"
                                                size="lg" placeholder="Pilih role" name="role_id"
                                                onChange={handleChange}
                                                showHint
                                                error={errors?.role_id} value={formData.role_id}/>
                                    </div>
                                    <div className="col-span-2">
                                        <Select showLabel label="Nama Aplikasi" options={formInit?.jenjang}
                                                labelKey="nama"
                                                valueKey="id"
                                    ...
                                    <div className="col-span-2">
                                        <Select showLabel label="Nama halaman" options={formInit?.jenjang}
                                                labelKey="nama"
                                                valueKey="id"
                                    ...
                                    <div className="col-span-3">
                                        <DateInput label="End akses" size="lg" showLabel placeholder="Date"
                                                   name="end_date"
