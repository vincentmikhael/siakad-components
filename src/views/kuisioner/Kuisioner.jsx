...
import {MagnifyingGlass, Plus, PencilSimpleLine, Trash, FadersHorizontal, Eye} from "@phosphor-icons/react";
...
const Kuisioner = () => {
    ...
    const columns = [
        {name: "no"},
        {name: "kode id", className: "min-w-[90px] text-center"},
        {name: "judul kuisioner", className: "min -w-[486px] w-full"},
        {name: "tanggal", className: "min-w-[156px] text-center"},
        {name: "keterangan", className: "min-w-[156px] text-center"},
        {name: "status", className: "min-w-[156px] text-center"},
                                    ...
                                    <TableBodyCell>
                                        <div className="flex flex-row gap-3 justify-center">
                                            <IconButton size="sm" variant="primary"
                                                        href={`/kuisioner/detail/${item?.kode_id}`}>
                                                <Eye/>
                                            </IconButton>
