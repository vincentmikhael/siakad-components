                    ...
                    <div style={{width: '100%'}}>
                        <div className="grid grid-cols-12 gap-4">
                            <div className="col-span-12 md:col-span-4">
                                <Select label="Lokasi kampus" showLabel placeholder="pilih lokasi kampus"
                            ...
                            <div className="col-span-12  md:col-span-4">
                                <Select label="Lantai" showLabel placeholder="Pilih lantai"
                                        options={[{value: "1", label: "Menu Item 1"}]}/>
                            </div>
                            ...
                            <div className="col-span-12  md:col-span-6">
                                <Select label="Program studi" showLabel placeholder="Pilih program studi"
                                        options={[{value: "1", label: "Menu Item 1"}]}/>
                            </div>
