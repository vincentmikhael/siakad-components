                ...
                <Modal.Body>
                    <div style={{width: '100%'}}>
                        ...
                        <form className="grid mt-2 grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <Input
                                    error={errors.nama && <Text size="xs" style={{color: 'red'}}>{errors.nama}</Text>}
                                    showHint value={formData.nama} onChange={handleForm('nama')} showLabel
                                    label="Nama konsentrasi" placeholder="Tulis nama konsentrasi"/>

                            </div>
                            <div>
                                <Input error={errors.nama_en &&
                                    <Text size="xs" style={{color: 'red'}}>{errors.nama_en}</Text>} showHint
                                       value={formData.nama_en} onChange={handleForm('nama_en')} showLabel
                                       label="Nama dalam inggris" placeholder="Tulis nama dalam bahasa inggris"/>

                            </div>
                            <div>
                                <Input
                                    error={errors.alias && <Text size="xs" style={{color: 'red'}}>{errors.alias}</Text>}
                                    showHint value={formData.alias} onChange={handleForm('alias')} showLabel
                                    label="Nama alias" placeholder="Tulis nama alias"/>
